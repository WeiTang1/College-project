...
public class Sprite
{
    ...
    // ALLOWS THE SPRITE TO BE ENABLED AND DISABLED
    ...
    /**
     * For accessing this sprite's action command
     */
    ...
    /**
     * Mutator method for specifying this Sprite's action command, which is
     * a textual representation of the command executed when someone clicks
     * on this sprite. This is useful when using sprites as buttons or other
     * clickable entities within a game.
     */
    public void setActionCommand(String initActionCommand)
    {
        actionCommand = initActionCommand;
    }
