...
public class pathXLevel {
    ...
    ArrayList<pathXIntersections> intersections;
    ...
    pathXIntersections startingLocation;
    String backgroundImageFileName;
    pathXIntersections destination;
                        ...
                        int destinationY)
    {
        ...
        startingLocation = new pathXIntersections(startingLocationX, startingLocationY);
        intersections.add(startingLocation);
        destination = new pathXIntersections(destinationX, destinationY);
    ...
    public ArrayList<pathXIntersections>  getIntersections()                  {   return intersections;                   }
    public ArrayList<pathXroad>          getRoads()                          {   return roads;                           }
    public pathXIntersections             getStartingLocation()               {   return startingLocation;                }
    public pathXIntersections             getDestination()                    {   return destination;                     }
    ...
    public void setStartingLocation(pathXIntersections startingLocation)
    {   this.startingLocation = startingLocation;                               }
    public void setDestination(pathXIntersections destination)
